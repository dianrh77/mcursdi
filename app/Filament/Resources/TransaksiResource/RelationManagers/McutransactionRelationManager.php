...
class McutransactionRelationManager extends RelationManager
{
    protected static string $relationship = 'mcutransaction';

    protected static ?string $title = 'Riwayat MCU';
                            ...
                            ->schema([
                                Section::make('A. Keadaan Umum')->schema([
                                    ...
                                    Forms\Components\Select::make('nadi_ket')
                                        ...
                                        ->options(['Reguler', 'Irreguler', 'Kuat', 'Lemah']),
                                    ...
                                    Forms\Components\Select::make('respirasi_ket')
                                        ...
                                        ->options(['Normal', 'Takipneu', 'Bradipneu']),
                                    ...
                                    Forms\Components\Select::make('suhu_ket')
                                        ...
                                        ->options(['Normotermi', 'Febris', 'Hiperpirexia']),
                                ])->columns(2),
                                ...
                                Section::make('D. Extremitas')->schema([
                                ...
                                Section::make('G. Rekomendasi')->schema([
    ...
    {
        return $table
            ->recordTitleAttribute('kd_rekmed')
            ->columns([
